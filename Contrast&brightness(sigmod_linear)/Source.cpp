...
int main3()
{
	Mat img = imread("hello.jpg", IMREAD_UNCHANGED); // Read in the image file
	...
	namedWindow("Image Window", WINDOW_AUTOSIZE); //WINDOW_AUTOSIZE Create a window of the same size as the image for display
