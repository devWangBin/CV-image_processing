...
{
	Mat image01 = imread("dst01.jpg", 1);    //右图
	Mat image02 = imread("合并01.png", 1);    //左图
	//imshow("p2", image01);
	//imshow("p1", image02);
   ...
   //计算配准图的四个顶点坐标
	...
	cout << "左上:" << corners.left_top << endl;
	cout << "左下:" << corners.left_bottom << endl;
	cout << "右上:" << corners.right_top << endl;
	cout << "右下:" << corners.right_bottom << endl;
